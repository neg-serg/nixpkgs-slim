...
let
  ...
  # Whitelist: packages actually used by the NixOS config (438 packages)
  # Generated from: grep -roh 'pkgs\.[a-zA-Z_0-9-]*' /etc/nixos/modules/ /etc/nixos/hosts/ --include='*.nix'
  whitelist = {
    abduco = null;
    abuse = null;
    acpi = null;
